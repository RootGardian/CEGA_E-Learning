...
// ─────────────────────────────────────────────
const wrapLayout = (bodyContent: string): string => {
...
// ─────────────────────────────────────────────
export const welcomeEmail = (firstName: string, loginUrl: string): { subject: string; text: string; html: string } => {
...
// ─────────────────────────────────────────────
export const resetPasswordEmail = (firstName: string, resetUrl: string): { subject: string; text: string; html: string } => {
...
// ─────────────────────────────────────────────
export const paymentConfirmationEmail = (firstName: string, amount: number, currency: string, transactionId: string, dashboardUrl: string): { subject: string; text: string; html: string } => {
